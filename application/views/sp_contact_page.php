        ...
        <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td height="25"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td align="center">&nbsp;</td>
                  <td><a href="index.php" class="class1">Casa</a><span class="foot">|</span> <span class="class1"><a href="career.php" class="class1">Carreras</a></span> <span class="foot">|</span> <span class="h2">Contáctenos</span> <span class="foot">|</span> <span class="content2"><a href="faq.php" class="class1">Faq `s</a></span></td>
                </tr>
              </table></td>
            </tr>
            <tr>
                ...
                <td bgcolor="#FFFFFF" style="padding-left:5px; padding-right:5px;"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                              <td colspan="2"><p><span class="h1">Switzerland</span> <br />
                                      <span class="content">dirección física<br />
                        ...
                        <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                              <td colspan="2"><p><span class="h1">Sudáfrica</span><br />
                                      <span class="content">dirección física <br />
                                        ...
                                        Johannesburgo<br />
                                       Sudáfrica</span></p>
                                  <p class="content">Dirección Postal<br />
                                    Mayla Investments CC en<br />
                                   PO Box 30626 <br />
                                    de mayo justo <br />
                                    2092 <br />
                  ...
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td width="84%" valign="top"><p align="justify" class="content"><span class="h1">Los clientes existentes:<br />
                            </span>Usted puede averiguar el estado de su cuenta de La Mayla Investments CC en, incluyendo todos los créditos, débitos, y su saldo actual, a través de nuestro Servicio de Atención al Cliente<br />
                            <br />
                          E-mail:<span class="content"><a class="easy-modal-open" id="1stmail" href="#modal1">info@maylainvest.com</a></span></p>
                            <p class="content"><span class="h1">Nuevos Clientes:</span><br />
                              No está seguro de con quién hablar? ¿Necesitas ayuda? Por favor E-mail a nuestro Servicio al Cliente<br />
                              <br />
...
<button class="close" valign="right" data-dismiss="modal" type="button" title="Close">X</button>
			<div class="mayla_cform">
					<h1 class="contacts">Póngase en Contacto Con Nosotros</h1>
...
<button class="close" valign="right" data-dismiss="modal" type="button" title="Close">X</button>
			<div class="mayla_cform">
				...
				<table>
					<tr>
						<td class="mayla-td">Envoyer à</td>
					...
					<tr>
						<td class="mayla-td">Número De Teléfono Del Usuario</td>
						<td><input class="input_field" type="text" id="userphone2" name="useremail" placeholder="Número De Teléfono Del Usuario"></td>
					</tr>
					<tr>
						<td class="mayla-td">Sujeto</td>
					...
					<tr>
						<td class="mayla-td">Mensaje</td>
						<td><textarea class="msgbox" id="usermessage2" placeholder="Escriba Su Mensaje Aquí"></textarea></td>
					</tr>
					<tr>
						<td class="mayla-td"></td>
						<td>
...
<button class="close" valign="right" data-dismiss="modal" type="button" title="Close">X</button>
			<div class="mayla_cform">
				...
				<table>
					...
					<tr>
						<td class="mayla-td">Número De Teléfono Del Usuario</td>
						<td><input class="input_field" type="text" id="userphone3" name="useremail" placeholder="Número De Teléfono Del Usuario"></td>
					</tr>
					<tr>
						<td class="mayla-td">Sujeto</td>
					...
					<tr>
						<td class="mayla-td">Mensaje</td>
						<td><textarea class="msgbox" id="usermessage3" placeholder="Escriba Su Mensaje Aquí"></textarea></td>
					</tr>
					<tr>
						<td class="mayla-td"></td>
						<td>
