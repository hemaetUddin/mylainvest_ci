...
<!--Vertical menu start-->
	<div class="vr-menu">
		<ul>
			<li><a class="vr_link" href="../espain/profile.php">Perfil</a></li>
			<li><a class="vr_link" href="../espain/structure.php">Empresa Structure</a></li>
			<li><a class="vr_link" href="../espain/service.php">Nuestro servicio</a></li>
			<li><a class="vr_link" href="../espain/job_descriptions.php">Tarbajo Descripciones</a></li>
			<li><a class="vr_link" href="../espain/payment_system.php">Cantidad y Reembolso</a></li>
			<li><a class="vr_link" href="#">Solicitud de Préstamo</a></li>
...
<!-- slider div end -->	
	<div class="header-bottom clear">
		<p class="hb-text">
BIENVENIDO A MAYLA INVESTMENTS CC WEB OFICIAL.</p>
	</div>
<!-- header bottom -->
	...
	<div class="right-side">
		<div class="">
			...
			<div class="mainFormHeader">
						<div class="formTitle">
							<p class="bank-info-header-text">éxito!!</p>
						</div>
		...
		// loop through all the files
			...
			// define some variables
				...
				if(!in_array($ext, $allowedExtensions)){
					die("Upload Plese importante documento!!");
				}
