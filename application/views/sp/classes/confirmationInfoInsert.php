<?php
	...
	if(isset($_POST['maylain_finalConfirm'])){
		...
		# codding Family Information Form End;

		#codding Upload Information Form Start;
		// $maylain_UploadAccessCode = filter_var($_POST['maylain_UploadAccessCode'],FILTER_SANITIZE_STRING);
		# codding Upload Information Form End;
		// codding Conformation Form End;
		...
		$myQuery="INSERT INTO `maylainvest`.`loanapplication`  VALUES (' ','$applicationNo', '$amountVal','$loanAmountInWords','$year','$month','$interest',
			...
			$result=$db->query($myQuery);
						...
						$subject = "Espanol | Loan Application";
						$mailText = "<div style=''>
				...
				if(mail($to,$subject,$mailText,$headers)){
					echo "Con éxito presentación de la solicitud. Muchas gracias. Le contestaremos en breve!!";
				}else
				{
					echo "Wrong";
				}
