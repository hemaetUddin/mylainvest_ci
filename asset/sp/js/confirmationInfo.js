$(document).ready(function(){
  ...
  $('#finalConfirm').click(function(){
    ...
    // Bank Information 
      ...
      alert(maylain_pPermanentAddress);
      ...
      function(result){
        ...
        if (result=="Con éxito presentación de la solicitud. Muchas gracias. Le contestaremos en breve!!") {
        // alert("Successfully Submitted the Application.")
        window.location = "http://localhost/mayla_Final_V.05/sp/bankInfoForm.php";
        }else{
          return false;
        };
